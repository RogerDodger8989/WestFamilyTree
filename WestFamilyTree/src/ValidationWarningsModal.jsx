...
export default function ValidationWarningsModal({ isOpen, warnings = [], onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/40">
      <div className="w-11/12 max-w-2xl bg-white rounded-lg shadow-lg p-4">
        ...
        <div className="mb-3 text-sm text-gray-700">Följande varningar upptäcktes när relationer föreslogs från källor. Dessa relationer har inte lagts till.</div>
