console.log('[PRELOAD] preload.js STARTAR:', __filename);
  console.log('[Electron preload] Preload.js loaded:', __filename);
  console.log('[Electron preload] window.electronAPI:', typeof window.electronAPI);
  window.addEventListener('DOMContentLoaded', () => {
    console.log('[Electron preload] DOMContentLoaded, electronAPI:', typeof window.electronAPI);
  });
  window.addEventListener('DOMContentLoaded', () => {
    console.log('Preload: DOMContentLoaded, electronAPI:', typeof window.electronAPI);
  });
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  importImages: (targetSubfolder) => ipcRenderer.invoke('import-images', targetSubfolder),
  selectMediaFolder: () => ipcRenderer.invoke('select-media-folder'),
  createZipFromFiles: (filePaths, fileNames) => ipcRenderer.invoke('create-zip-from-files', filePaths, fileNames),
