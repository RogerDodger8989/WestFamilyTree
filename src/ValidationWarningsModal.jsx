...
export default function ValidationWarningsModal({ isOpen, warnings = [], onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/40">
      <div className="w-11/12 max-w-2xl bg-surface border border-subtle rounded-lg shadow-lg p-4">
        ...
        <div className="mb-3 text-sm text-primary">Följande varningar upptäcktes när relationer föreslogs från källor. Dessa relationer har inte lagts till.</div>
        ...
        <div className="flex justify-end gap-2">
          <button onClick={() => { try { handleTabChange('audit'); onClose(); } catch (e) { showStatus('Kunde inte öppna historiken.'); } }} className="px-3 py-2 bg-accent text-on-accent rounded">Öppna historiken</button>
